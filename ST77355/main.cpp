...
extern "C" int main() {
    ...
    */
    ...
    //SoftwareSPI spi(16, SCL_PIN, SDA_PIN);

    // Tie CS into the SPI hardware
	spi.setDedicated(CS_PIN);

    ST7735_pico screen(&spi,CS_PIN, DC_PIN,RES_PIN); // CS pin supplied but will be controlled by SPI object.
    ...
    // 1.8 inch 128 x 160 pixel.  No touchscreen and micro SD card on back.
