...
uint8_t BMP085::read8(uint8_t a) {
  ...
  i2c_dev->write(BMP085_I2CADDR,&a,1,true);
  i2c_dev->read(BMP085_I2CADDR,&ret,1,false);
...
uint16_t BMP085::read16(uint8_t a) {
  ...
  // endianness
  i2c_dev->write(BMP085_I2CADDR,&a,1,true);
  i2c_dev->read(BMP085_I2CADDR, retbuf,2,false);
...
void BMP085::write8(uint8_t a, uint8_t d) {
  ...
  i2c_dev->write(BMP085_I2CADDR,buff,2,true);
 }
