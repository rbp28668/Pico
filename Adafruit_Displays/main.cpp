...
extern "C" int main() {
    ...
    */
    ...
    HardwareSPI spi(spi0, 16, SCL_PIN, SDA_PIN, 2000000); // CS pin not part of SPI per se as really tied to addressable device
    Adafruit_ILI9341 screen(&spi,CS_PIN, DC_PIN,RES_PIN); // Hence CS is included here.
